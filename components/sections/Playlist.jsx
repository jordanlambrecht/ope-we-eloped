    ...
    <PageSection color={'cream'} id='playlist'>
      <InnerWrapper>
        ...
        <p className='italic text-sm mt-2'>
          Note: Any submissions of the &apos;Chicken Dance,&apos; the &apos;Cha Cha Slide,&apos; or
          anything written by Ed Sheeran will result in immediate denial of entry at the event. Not
          really. But maybe.
        </p>
      </InnerWrapper>
