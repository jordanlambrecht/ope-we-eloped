        ...
        <div className='mt-12'>
          ...
          <div>
            ...
            <p className='mb-6'>
              ...
              health was a solid 2 out of 10. So I decided it was the perfect time to meet someone.{' '}
            </p>
            <p className='mb-6'>
              I downloaded Tinder and uploaded a photo of myself sitting on the floor of a New York
              City subway car devouring nachos. Then, I uploaded 5 additional photos that were just
              of my cats.{' '}
            </p>
            <p className='mb-6'>
              I swiped right on Jordan. He swiped right on me. I’m still not sure why he read my bio
              and thought, “this is definitely someone I should initiate an interaction with,” but
              I’m thankful he did.{' '}
            </p>
            <p className='mb-6'>
              We texted. I forgot to respond. He triple-texted. We decided to meet in-person. Then I
              rescheduled several times. 30 minutes after we were supposed to meet, I called him to
              say: “Hey, so, I’m not an ‘on-time’ person. I’m running super late, but I’m on my
              way.”{' '}
            </p>
            <p className='mb-6'>
        ...
        <div className='mt-12'>
          ...
          <div>
            ...
            <p className='mb-6'>
              ...
              define it is the French phrase ‘Joie De Vivre’, an exultation of spirit. When you look
              into her eyes long enough, there’s a flame. Bergen is a tiny human with a booming life
              force. It was as if there was an invisible, swirling energy manifesting outwards from
              an incredible presence.{' '}
            </p>
            <p className='mb-6'>
              You’d think that would equate to some boisterous tank of a human, but it doesn’t. She
              was/is calm, soft-spoken, and gentle. She laughed at my stupid jokes. She never broke
              eye contact once when I helplessly spilled out secrets I had never told anyone before.
              She pretended to like Fuji.
            </p>
            <p className='mb-6'>
        ...
        <div className='mt-12'>
          ...
          <div>
            ...
            <p className='mb-6'>
              ...
              was 2:30pm, and Jordan called the courthouse to see if it was possible to get married
              that afternoon. The person who answered probably thought we were insane. They said,
              “yeah, but you’d have to get here before 4pm.”{' '}
            </p>
            <p className='mb-6'>
              Then I asked Jordan if he actually wanted to get married today. He said yes. Then, he
              got down on both knees and asked me the same thing.{' '}
            </p>
            <p className='mb-6'>
              ...
              asked (except for “is it fine if I’m wearing jeans?”). We got married at 4:30pm. Mike
              bought us burrito bowls at Chipotle.{' '}
            </p>
          ...
          <div>
            <p className='mt-12 font-semibold italic'>Jordan:</p>
            <p className='mb-6'>
              Bergen is leaving out a critical part for my benefit. What she didn&apos;t mention is
              that I was having one of, not even exaggerating, the worse days of my life
            </p>
            <p className='mb-6'>
              That&apos;s the kind of person she is and it&apos;s one of the things I love the most
              about her. She can take the most abhorrent things in the world and replace them with
              good. Everything she does adds a net gain to the universe.{' '}
            </p>
          </div>
        </div>
      </InnerWrapper>
